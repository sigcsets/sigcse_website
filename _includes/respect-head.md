...
> <a name="top" id="top"></a> {% if conf.year <= first_yr %}{% else %} <a href="{{prev}}.html">← Previous</a> &#124; {% endif %}<a href="conferences.html">Respect Index</a> {% if conf.year == last_yr %}{% else %} &#124; <a href="{{next}}.html">Next →</a>{% endif %}
...
{% capture proc_cover_path %}/events/respect/images/covers/respect{{conf.year}}.png{% endcapture %}
...
{% include awards.md event="RESPECT" %}
